import {Renderable, RenderableId, CommonRenderProps} from "../../types/Types";
import {textureCache} from "../../renderer/textures/Textures";
import {mat4} from "gl-matrix";

export const createSceneThunk = ({gl, program, camera}:CommonRenderProps) => {
